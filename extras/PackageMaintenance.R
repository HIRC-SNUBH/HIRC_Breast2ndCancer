...
OhdsiRTools::checkUsagePackage("breastCxSPM")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/breastCxSPM.pdf")
shell("R CMD Rd2pdf ./ --output=extras/breastCxSPM.pdf")
...
OhdsiRTools::createRenvLockFile("breastCxSPM")
